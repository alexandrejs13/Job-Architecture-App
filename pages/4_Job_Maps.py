...
st.markdown('''<h1 class="page-title"><img src="assets/icons/globe_trade.png" width="48" style="vertical-align:middle;margin-right:12px;">Job Maps</h1>''',unsafe_allow_html=True)
