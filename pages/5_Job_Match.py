...
st.markdown('''<h1 class="page-title"><img src="assets/icons/checkmark_success.png" width="48" style="vertical-align:middle;margin-right:12px;">Job Match</h1>''',unsafe_allow_html=True)
