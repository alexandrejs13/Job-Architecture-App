...
st.markdown('''<h1 class="page-title"><img src="assets/icons/data_2_performance.png" width="48" style="vertical-align:middle;margin-right:12px;">Dashboard</h1>''',unsafe_allow_html=True)
